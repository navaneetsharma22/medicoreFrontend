...
export default function ProCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl p-5 mb-2 hover-gradient-border group transition-all duration-300 transform hover:scale-[1.02] shadow-[0_0_20px_rgba(47,158,143,0.3)] animate-float">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#2F9E8F] to-[#1F7A6B] z-0" />
